defmodule PortfolioWeb.Navbar do
  # In Phoenix apps, the line is typically: 
  ...
  def render(assigns) do
    ~H"""
    <div>
        <nav class="flex items-center justify-between flex-wrap bg-gradient-to-r from-orange-500 to-orange-200 p-6">
            <div class="flex items-center flex-shrink-0 text-white mr-6">
            <span href="home" class="font-semibold text-xl tracking-tight">Precious Hamilton</span>
            </div>
